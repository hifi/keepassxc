...
public:
    ...
    virtual bool exec(AutoTypeExecutor* executor) = 0;
...
public:
    ...
    bool exec(AutoTypeExecutor* executor) override;
...
public:
    ...
    virtual bool execBegin(const AutoTypeBegin* action) = 0;
    virtual bool execType(const AutoTypeKey* action) = 0;
    virtual bool execClearField(const AutoTypeClearField* action) = 0;
