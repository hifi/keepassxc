...
public:
    ...
    void setAllowUseOfSshKey(bool);
    void setAddAtDatabaseOpen(bool);
    void setRemoveAtDatabaseClose(bool);
    void setUseConfirmConstraintWhenAdding(bool);
    void setUseLifetimeConstraintWhenAdding(bool);
    void setLifetimeConstraintDuration(int);

    void setSelectedType(const QString &);
    void setAttachmentName(const QString &);
