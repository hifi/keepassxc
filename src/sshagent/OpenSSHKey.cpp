...
QString OpenSSHKey::type()
{
    return m_type;
}

int OpenSSHKey::keyLength()
{
...
QString OpenSSHKey::fingerprint()
{
...
QString OpenSSHKey::comment()
{
    return m_comment;
}

QString OpenSSHKey::publicKey()
{
    QByteArray publicKey;
    BinaryStream stream(&publicKey);
...
QString OpenSSHKey::errorString()
{
    return m_error;
}
